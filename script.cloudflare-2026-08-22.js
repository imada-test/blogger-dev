(function () {
  ...
  const waitReady = setInterval(() => {
    ...
    /* ---------------------------------------------------------
     * ⑥ FeedSection コンポーネント（純粋な HTML 版）
     * --------------------------------------------------------- */
    const FeedSection = {
      props: {
        ...
        <div class="feed-section-wrapper">
          ...
          <section style="margin-bottom: 32px;">
            ...
            <p style="margin-top: 12px;">
              新しい投稿を書いてここに表示するには、
              <b>{{ label }}</b> と <b>概要</b> をラベル欄に入力して公開してください。
            </p>
            ...
            <ul style="margin-top: 12px;">
              <li v-for="item in overview" :key="item.id" style="margin-bottom: 12px;">
                <a :href="item.link" style="font-weight: bold; color: #1a73e8;">
                  {{ item.title }}
                </a>
          ...
          <section style="margin-bottom: 32px;">
            ...
            <ul style="margin-top: 12px;">
              <li v-for="item in latest" :key="item.id" style="margin-bottom: 12px;">
                <a :href="item.link" style="font-weight: bold; color: #1a73e8;">
                  {{ item.title }}
                </a>
                <div style="font-size: 0.85rem; color: #666;">
          ...
          <section style="margin-bottom: 32px;">
            ...
            <p style="margin-top: 12px;">
              新しい投稿を書いてここに表示するには、
              <b>{{ label }}</b> と <b>重要</b> をラベル欄に入力して公開してください。
            </p>
            ...
            <ul style="margin-top: 12px;">
              <li v-for="item in important" :key="item.id" style="margin-bottom: 12px;">
                <a :href="item.link" style="font-weight: bold; color: #1a73e8;">
                  {{ item.title }}
                </a>
                <div style="font-size: 0.85rem; color: #666;">
